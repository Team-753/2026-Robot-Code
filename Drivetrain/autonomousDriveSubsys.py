...
class autoDriveTrainCommand(commands2.Command):
    def __init__(self,driveSubsys:driveTrainSubsys):
        ...
        self.xPid=cont.PIDController(2.5,0.1,0)
        self.yPid=cont.PIDController(2.5,0.1,0)
        self.omegaPid=cont.ProfiledPIDControllerRadians(0.3,0,0,wpimath.trajectory.TrapezoidProfileRadians.Constraints(pi,pi))
        self.traj=choreo.load_swerve_trajectory("NewPath")
